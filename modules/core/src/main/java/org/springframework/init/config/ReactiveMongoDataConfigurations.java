 ...
 *
 */
@SelectedAutoConfiguration(classes = { MongoReactiveAutoConfiguration.class,
		EmbeddedMongoAutoConfiguration.class, MongoReactiveDataAutoConfiguration.class,
		MongoReactiveRepositoriesAutoConfiguration.class }, depends = BasicConfigurations.class)
