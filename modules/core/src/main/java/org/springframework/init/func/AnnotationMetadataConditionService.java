 ...
 *
 */
public class AnnotationMetadataConditionService implements ConditionService {
	...
	public AnnotationMetadataConditionService(GenericApplicationContext context) {
	...
	public boolean includes(Class<?> type) {
		if (!FunctionalInstallerListener.EXCLUDES_ENABLED) {
			return true;
		}
