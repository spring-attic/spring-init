...
public class CustomizerApplication {
	...
	public static void main(String[] args) {
		SpringApplication application = new FactorySpringApplication(CustomizerApplication.class);
...
class FactoriesApplicationCustomizer implements SpringApplicationCustomizer {
	...
	public void customize(SpringApplication application, String[] args) {
		application.setListeners(Arrays.asList(new BackgroundPreinitializer(), new ConfigFileApplicationListener(),
				new LoggingApplicationListener(), new BeanCountingApplicationListener(),
				new StartupApplicationListener()));
		application.setInitializers(Arrays.asList(new ContextIdApplicationContextInitializer()));
	}
